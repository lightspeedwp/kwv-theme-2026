...
<div class="wp-block-woocommerce-coming-soon woocommerce-coming-soon-store-only">
	...
	<!-- wp:group {"metadata":{"name":"Coming Soon Container"},"layout":{"type":"constrained"}} -->
		...
		<!-- wp:group {"metadata":{"name":"Coming Soon Content"},"style":{"spacing":{"margin":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"},"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30","left":"var:preset|spacing|40","right":"var:preset|spacing|40"},"blockGap":"var:preset|spacing|20"},"border":{"radius":{"topLeft":"var:preset|border-radius|md","topRight":"var:preset|border-radius|md","bottomLeft":"var:preset|border-radius|md","bottomRight":"var:preset|border-radius|md"}}},"backgroundColor":"neutral-200","layout":{"type":"constrained"}} -->
			...
			<!-- wp:heading {"textAlign":"center","level":1,"fontSize":"500","fontFamily":"cardo"} -->
			...
			<!-- /wp:heading -->
			<!-- wp:paragraph {"align":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|neutral-700"}}}},"textColor":"neutral-700","fontFamily":"inter"} -->
