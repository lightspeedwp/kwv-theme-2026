...
<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20)"><!-- wp:paragraph {"align":"wide","className":"kwv-back-link","style":{"typography":{"fontStyle":"normal","fontWeight":"var:custom|font-weight|bold","textTransform":"uppercase"},"elements":{"link":{"color":{"text":"var:preset|color|brand-500"},":hover":{"color":{"text":"var:preset|color|brand-600"}}}}},"textColor":"brand-500","fontSize":"200"} -->
<p class="alignwide kwv-back-link has-brand-500-color has-text-color has-link-color has-200-font-size" style="font-style:normal;font-weight:var(--wp--custom--font-weight--bold);text-transform:uppercase"><a href="/visit/">&larr; <?php esc_html_e( 'Back to Visit', 'kwv' ); ?></a></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group"><!-- wp:paragraph {"metadata":{"name":"Event Date","bindings":{"content":{"source":"kwv/meta-date","args":{"key":"kwv_event_date","format":"j F Y"}}}},"style":{"spacing":{"margin":{"top":"0","bottom":"0"}},"typography":{"fontStyle":"normal","fontWeight":"var:custom|font-weight|regular","textTransform":"uppercase"}},"textColor":"neutral-700","fontSize":"200"} -->
<p class="has-neutral-700-color has-text-color has-200-font-size" style="margin-top:0;margin-bottom:0;font-style:normal;font-weight:var(--wp--custom--font-weight--regular);text-transform:uppercase"><?php esc_html_e( 'Event date', 'kwv' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"metadata":{"name":"Event Time","bindings":{"content":{"source":"core/post-meta","args":{"key":"kwv_event_time"}}}},"style":{"spacing":{"margin":{"top":"0","bottom":"0"}},"typography":{"fontStyle":"normal","fontWeight":"var:custom|font-weight|regular","textTransform":"uppercase"}},"textColor":"neutral-700","fontSize":"200"} -->
<p class="has-neutral-700-color has-text-color has-200-font-size" style="margin-top:0;margin-bottom:0;font-style:normal;font-weight:var(--wp--custom--font-weight--regular);text-transform:uppercase"><?php esc_html_e( 'Time', 'kwv' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
