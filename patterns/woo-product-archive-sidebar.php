 ...
 * Slug: kwv/woo-product-archive-sidebar
...
<!-- wp:group {"tagName":"main","metadata":{"name":"Main Content"},"style":{"spacing":{"margin":{"top":"0","bottom":"0"},"blockGap":"0"}},"layout":{"inherit":true,"type":"constrained"}} -->
	...
	<!-- wp:group {"metadata":{"name":"Archive Header"},"align":"full","style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30"}}},"backgroundColor":"neutral-200","layout":{"type":"constrained"}} -->
		...
		<!-- wp:columns {"verticalAlignment":"bottom","metadata":{"name":"Header Columns"},"align":"wide"} -->
			...
			<!-- wp:column {"verticalAlignment":"bottom","metadata":{"name":"Title Column"},"style":{"spacing":{"blockGap":"var:preset|spacing|20"}}} -->
				...
				<!-- wp:query-title {"type":"archive","showPrefix":false,"align":"wide","fontSize":"500"} /-->
				</div>
			<!-- /wp:column -->
			<!-- wp:column {"verticalAlignment":"bottom","metadata":{"name":"Description Column"},"style":{"spacing":{"blockGap":"var:preset|spacing|20"}}} -->
				<div class="wp-block-column is-vertically-aligned-bottom">
				<!-- wp:term-description {"align":"wide","style":{"elements":{"link":{"color":{"text":"var:preset|color|neutral-700"}}}},"textColor":"neutral-700","fontSize":"100"} /-->
				</div>
			<!-- /wp:column -->
			</div>
		<!-- /wp:columns -->
	...
	<!-- /wp:group -->
	<!-- wp:group {"metadata":{"name":"Product Grid Section"},"align":"full","style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|50"},"blockGap":"var:preset|spacing|40"}},"layout":{"type":"constrained"}} -->
		<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50)">
			...
			<!-- wp:column {"width":"30%"} -->
				...
				<!-- wp:group {"metadata":{"name":"Sidebar"},"style":{"border":{"radius":{"topLeft":"var:preset|border-radius|md","topRight":"var:preset|border-radius|md","bottomLeft":"var:preset|border-radius|md","bottomRight":"var:preset|border-radius|md"}}},"layout":{"type":"constrained"}} -->
					...
					<!-- wp:woocommerce/product-filters -->
						...
						<!-- wp:heading {"style":{"margin":{"top":"0","bottom":"0"},"spacing":{"margin":{"top":"0","bottom":"0"}}},"fontSize":"200"} -->
							<h2 class="wp-block-heading has-200-font-size" style="margin-top:0;margin-bottom:0">Filters</h2>
						<!-- /wp:heading -->
						<!-- wp:woocommerce/product-filter-active -->
							...
							<!-- wp:woocommerce/product-filter-clear-button -->
								<!-- wp:buttons {"layout":{"type":"flex","verticalAlignment":"stretched"}} -->
									...
									<!-- wp:button {"textAlign":"center","width":100,"className":"wc-block-product-filter-clear-button is-style-button-dark","style":{"typography":{"textDecoration":"none"},"outline":"none","fontSize":"400","spacing":{"padding":{"left":"0.6rem","right":"0.6rem","top":"0.6rem","bottom":"0.6rem"}}}} -->
						...
						<!-- wp:woocommerce/product-filter-price -->
							...
							<!-- wp:heading {"level":3,"style":{"spacing":{"margin":{"bottom":"0.625rem","top":"0"}}},"fontSize":"200"} -->
								<h3 class="wp-block-heading has-200-font-size" style="margin-top:0;margin-bottom:0.625rem">Price</h3>
							<!-- /wp:heading -->
						...
						<!-- wp:woocommerce/product-filter-rating -->
							...
							<!-- wp:heading {"level":3,"style":{"spacing":{"margin":{"bottom":"0.625rem","top":"0"}}},"fontSize":"200"} -->
								<h3 class="wp-block-heading has-200-font-size" style="margin-top:0;margin-bottom:0.625rem">Rating</h3>
							<!-- /wp:heading -->
						...
						<!-- wp:woocommerce/product-filter-attribute -->
							...
							<!-- wp:heading {"level":3,"style":{"spacing":{"margin":{"bottom":"0.625rem","top":"0"}}},"fontSize":"200"} -->
								<h3 class="wp-block-heading has-200-font-size" style="margin-top:0;margin-bottom:0.625rem">Brand</h3>
							<!-- /wp:heading -->
							<!-- wp:woocommerce/product-filter-checkbox-list -->
								<div class="wp-block-woocommerce-product-filter-checkbox-list wc-block-product-filter-checkbox-list"></div>
							<!-- /wp:woocommerce/product-filter-checkbox-list -->
						...
						<!-- wp:woocommerce/product-filter-taxonomy -->
							...
							<!-- wp:heading {"level":3,"style":{"spacing":{"margin":{"bottom":"0.625rem","top":"0"}}},"fontSize":"200"} -->
								<h3 class="wp-block-heading has-200-font-size" style="margin-top:0;margin-bottom:0.625rem">Category</h3>
							<!-- /wp:heading -->
							<!-- wp:woocommerce/product-filter-checkbox-list -->
								<div class="wp-block-woocommerce-product-filter-checkbox-list wc-block-product-filter-checkbox-list"></div>
							<!-- /wp:woocommerce/product-filter-checkbox-list -->
						...
						<!-- wp:woocommerce/product-filter-status -->
							...
							<!-- wp:heading {"level":3,"style":{"spacing":{"margin":{"bottom":"0.625rem","top":"0"}}},"fontSize":"200"} -->
								<h3 class="wp-block-heading has-200-font-size" style="margin-top:0;margin-bottom:0.625rem">Status</h3>
							<!-- /wp:heading -->
							<!-- wp:woocommerce/product-filter-checkbox-list -->
								<div class="wp-block-woocommerce-product-filter-checkbox-list wc-block-product-filter-checkbox-list"></div>
							<!-- /wp:woocommerce/product-filter-checkbox-list -->
