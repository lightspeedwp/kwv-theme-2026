...
<!-- wp:group {"metadata":{"name":"Breadcrumbs"},"align":"wide","style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|20","right":"var:preset|spacing|20"}}},"backgroundColor":"neutral-200","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignwide has-neutral-200-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)">
...
<!-- /wp:group -->
<!-- wp:group {"tagName":"main","metadata":{"name":"Main Content"},"style":{"spacing":{"margin":{"top":"0","bottom":"0"},"blockGap":"var:preset|spacing|50","padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"}}},"layout":{"inherit":true,"type":"constrained"}} -->
	...
	<!-- wp:group {"metadata":{"name":"Product Layout"},"align":"full","style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
		...
		<!-- wp:group {"metadata":{"name":"Store Notice"},"align":"wide","style":{"spacing":{"margin":{"top":"0","bottom":"var:preset|spacing|40"}}},"layout":{"type":"constrained"}} -->
			...
			<!-- wp:column {"width":"512px"} -->
				...
				<!-- wp:woocommerce/product-gallery {"hoverZoom":false,"layout":{"type":"flex","flexWrap":"nowrap","orientation":"vertical"}} -->
					...
					<!-- wp:woocommerce/product-gallery-large-image -->
						...
						<!-- wp:woocommerce/product-sale-badge {"align":"right","backgroundColor":"contrast","textColor":"base","fontSize":"100","style":{"border":{"width":"0px","style":"none","radius":{"topLeft":"100px","topRight":"100px","bottomLeft":"100px","bottomRight":"100px"}},"elements":{"link":{"color":{"text":"var:preset|color|base"}}},"spacing":{"margin":{"top":"5px","right":"5px"}}}} /-->
			...
			<!-- wp:column -->
				...
				<!-- wp:group {"metadata":{"name":"Product Details Wrapper"},"style":{"dimensions":{"minHeight":"100%"}},"layout":{"type":"constrained"}} -->
					...
					<!-- wp:group {"metadata":{"name":"Product Info Section"},"style":{"position":{"type":"sticky","top":"0px"}},"layout":{"type":"constrained"},"stickyScrollOffset":"25px"} -->
						...
						<!-- wp:group {"metadata":{"name":"Product Details"},"style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"layout":{"type":"constrained"}} -->
							<div class="wp-block-group">
							<!-- wp:post-title {"level":1,"fontSize":"500","__woocommerceNamespace":"woocommerce/product-query/product-title"} /-->
							<!-- wp:woocommerce/product-price {"isDescendentOfSingleProductTemplate":true,"fontSize":"200"} /-->
							<!-- wp:woocommerce/product-rating {"isDescendentOfSingleProductTemplate":true,"fontSize":"100"} /-->
							<!-- wp:post-excerpt {"excerptLength":100,"fontSize":"300","__woocommerceNamespace":"woocommerce/product-query/product-summary"} /-->
							</div>
						<!-- /wp:group -->
						...
						<!-- wp:group {"metadata":{"name":"Product Meta Badges"},"className":"","layout":{"type":"flex","flexWrap":"nowrap"}} -->
							...
							<!-- wp:group {"metadata":{"name":"Secure Checkout Badge"},"style":{"spacing":{"blockGap":"6px"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
								<div class="wp-block-group">
								<!-- wp:outermost/icon-block {"iconName":"kwv-phosphor-shield-check","customIconColor":"#30b241","iconColorValue":"#30b241","width":"20px"} -->
								...
								<!-- wp:paragraph {"fontSize":"100"} -->
									<p class="has-100-font-size">Safe and secure checkout</p>
								<!-- /wp:paragraph -->
								</div>
							<!-- /wp:group -->
							<!-- wp:group {"className":"product-meta-row","style":{"spacing":{"blockGap":"6px"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
								<div class="wp-block-group product-meta-row">
								<!-- wp:outermost/icon-block {"iconName":"kwv-phosphor-package","customIconColor":"#30b241","iconColorValue":"#30b241","width":"20px"} -->
								...
								<!-- /wp:outermost/icon-block -->
								<!-- wp:woocommerce/product-stock-indicator {"fontSize":"100"} /-->
								</div>
							<!-- /wp:group -->
							</div>
						<!-- /wp:group -->
	...
	<!-- /wp:group -->
	<!-- wp:group {"metadata":{"name":"Product Details"},"align":"wide","style":{"border":{"radius":{"topLeft":"var:preset|border-radius|sm","topRight":"var:preset|border-radius|sm","bottomLeft":"var:preset|border-radius|sm","bottomRight":"var:preset|border-radius|sm"}},"spacing":{"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30","left":"var:preset|spacing|30","right":"var:preset|spacing|30"}}},"backgroundColor":"neutral-200","layout":{"type":"constrained"}} -->
		<div class="wp-block-group alignwide has-neutral-200-background-color has-background" style="border-top-left-radius:var(--wp--preset--border-radius--sm);border-top-right-radius:var(--wp--preset--border-radius--sm);border-bottom-left-radius:var(--wp--preset--border-radius--sm);border-bottom-right-radius:var(--wp--preset--border-radius--sm);padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30)">
		<!-- wp:group {"metadata":{"name":"Product Tabs Container"},"align":"wide","style":{"border":{"radius":{"topLeft":"var:preset|border-radius|sm","topRight":"var:preset|border-radius|sm","bottomLeft":"var:preset|border-radius|sm","bottomRight":"var:preset|border-radius|sm"}}},"layout":{"type":"constrained"}} -->
			...
			<!-- wp:woocommerce/product-meta {"align":"wide","metadata":{"ignoredHookedBlocks":["core/post-terms"]}} -->
				...
				<!-- wp:group {"metadata":{"name":"Product Taxonomy Links"},"style":{"spacing":{"blockGap":"var:preset|spacing|20"},"elements":{"link":{"color":{"text":"var:preset|color|neutral-700"}}},"position":{"type":""}},"textColor":"neutral-700","fontSize":"100","layout":{"type":"flex","flexWrap":"nowrap"}} -->
					<div class="wp-block-group has-neutral-700-color has-text-color has-link-color has-100-font-size">
	...
	<!-- wp:woocommerce/product-collection {"queryId":3,"query":{"perPage":4,"pages":1,"offset":0,"postType":"product","order":"asc","orderBy":"title","search":"","exclude":[],"inherit":false,"taxQuery":[],"isProductCollectionBlock":true,"featured":false,"woocommerceOnSale":false,"woocommerceStockStatus":["instock","onbackorder"],"woocommerceAttributes":[],"woocommerceHandPickedProducts":[],"filterable":false,"relatedBy":{"categories":true,"tags":true}},"tagName":"div","displayLayout":{"type":"flex","columns":4,"shrinkColumns":false},"dimensions":{"widthType":"fill"},"collection":"woocommerce/product-collection/related","hideControls":["inherit"],"queryContextIncludes":["collection"],"__privatePreviewState":{"isPreview":true,"previewMessage":"Actual products will vary depending on the product being viewed."},"align":"wide"} -->
		...
		<!-- wp:heading {"style":{"spacing":{"margin":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30"}}},"fontSize":"400"} -->
			<h2 class="wp-block-heading has-400-font-size" style="margin-top:var(--wp--preset--spacing--30);margin-bottom:var(--wp--preset--spacing--30)">
			Related products			</h2>
		<!-- /wp:heading -->
