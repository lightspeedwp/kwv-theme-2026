...
<div class="wp-block-group alignwide"><!-- wp:heading {"level":1,"align":"wide","style":{"typography":{"fontStyle":"normal","fontWeight":"var:custom|font-weight|semi-bold","letterSpacing":"0.03em"}},"textColor":"base","fontSize":"800"} -->
<h1 class="wp-block-heading alignwide has-base-color has-text-color has-800-font-size" style="font-style:normal;font-weight:var(--wp--custom--font-weight--semi-bold);letter-spacing:0.03em"><?php esc_html_e( 'News', 'kwv' ); ?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
