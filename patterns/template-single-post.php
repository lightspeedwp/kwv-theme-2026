...
<p class="alignwide kwv-back-link has-brand-500-color has-text-color has-link-color has-200-font-size" style="font-style:normal;font-weight:var(--wp--custom--font-weight--bold);text-transform:uppercase"><a href="<?php echo esc_url( $kwv_news_url ); ?>">&larr; <?php esc_html_e( 'Back to News', 'kwv' ); ?></a></p>
<!-- /wp:paragraph -->
