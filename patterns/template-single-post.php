...
<main class="wp-block-group alignfull is-style-light-page-section" style="margin-top:0;margin-bottom:0">

	<!-- wp:group {"metadata":{"name":"Article Header"},"align":"wide","layout":{"type":"constrained","contentSize":"1100px"}} -->
		...
		<div class="wp-block-columns alignwide">
			...
			<div class="wp-block-column is-vertically-aligned-center">
				...
				<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20)">
					<!-- wp:paragraph {"align":"wide","className":"kwv-back-link","style":{"typography":{"fontStyle":"normal","fontWeight":"700","textTransform":"uppercase"},"elements":{"link":{"color":{"text":"var:preset|color|brand-500"},":hover":{"color":{"text":"var:preset|color|brand-600"}}}}},"textColor":"brand-500","fontSize":"200"} -->
					...
					<div class="wp-block-group alignwide">
						<!-- wp:post-title {"level":1,"align":"wide","style":{"typography":{"fontWeight":"var:custom|font-weight|bold","lineHeight":"var:custom|line-height|heading","textTransform":"uppercase","letterSpacing":"1px"}},"textColor":"contrast","fontSize":"600","fontFamily":"heading"} /-->

						<!-- wp:post-date {"format":"F j, Y","metadata":{"bindings":{"datetime":{"source":"core/post-data","args":{"field":"date"}}}},"style":{"typography":{"fontStyle":"normal","fontWeight":"400","textTransform":"uppercase"},"border":{"left":{"width":"0px","style":"none"}},"spacing":{"padding":{"top":"var:preset|spacing|10","bottom":"var:preset|spacing|10","left":"var:preset|spacing|5"}}},"textColor":"neutral-700","fontSize":"200"} /-->
					</div>
					<!-- /wp:group -->
					...
					<div class="wp-block-group">
						<!-- wp:group {"metadata":{"name":"Byline"},"style":{"spacing":{"blockGap":"var:preset|spacing|30"}},"layout":{"type":"constrained"}} -->
						<div class="wp-block-group">
							...
							<div class="wp-block-group">
								...
								<div class="wp-block-group">
									<!-- wp:post-author-name {"style":{"typography":{"fontWeight":"var:custom|font-weight|bold","lineHeight":"var:custom|line-height|snug","textTransform":"uppercase"}},"textColor":"contrast","fontSize":"200","fontFamily":"heading"} /-->
			...
			<div class="wp-block-column is-vertically-aligned-center">
				<!-- wp:post-featured-image {"aspectRatio":"4/3","align":"wide","style":{"spacing":{"margin":{"top":"0","bottom":"0"}}}} /-->
			</div>
			<!-- /wp:column -->
		</div>
		<!-- /wp:columns -->
	...
	<div class="wp-block-group">
		...
		<div class="wp-block-group">
			<!-- wp:post-navigation-link {"type":"previous","showTitle":true,"className":"kwv-post-nav","style":{"typography":{"textAlign":"left"}},"fontSize":"200"} /-->
		</div>
		<!-- /wp:group -->

		<!-- wp:group {"metadata":{"name":"Next"},"style":{"spacing":{"blockGap":"var:preset|spacing|5"}},"layout":{"type":"constrained","contentSize":"400px"}} -->
		<div class="wp-block-group">
			<!-- wp:post-navigation-link {"showTitle":true,"className":"kwv-post-nav","style":{"typography":{"textAlign":"right"}},"fontSize":"200"} /-->
		</div>
		<!-- /wp:group -->
	</div>
	<!-- /wp:group -->
